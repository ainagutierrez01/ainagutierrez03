...
COS = (2 * pi * Xp / lambda) + phi; % equation of the cosinus part from the pwp % The sinusoid!

GAUSS = - (Xp.*Xp +Yp.*Yp*gamma.*gamma) / (2 * sigma*sigma); % equation of the exponential part from the pwp % The gaussian! 
G = exp(GAUSS) .* cos(COS); % equation unificating GAUSS and COS fromt the pwp % The Gabor! 
